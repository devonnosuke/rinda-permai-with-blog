    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="container mt-5 form">
                <div class="row">
                    <div class="col-md-6">
                        <h1 class="h3 mb-2 text-gray-800"><i class="bi bi-plus-circle-dotted"></i> Data Category disini:</h1>
                    </div>
                    ...
                    <div class="card-body">
                        <form class="px-2 mb-5 user" action="<?= base_url(); ?>/admin/category/save" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="name" class="form-label mt-4">Masukkan Category baru</label>
                                <input type="text" class="form-control form-control-user <?= ($validation->hasError('category_name')) ? 'is-invalid' : ''; ?>" name="category_name" id="name" placeholder="masukkan category disini..." value="<?= old('category_name'); ?>" />

...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-white">Form Tambah Comment</h6>
        </div>
        <div class="card-body">
            <div class="container mt-5 form">
                ...
                <div class="card bg-light mb-3">
                    <div class="card-body">
                        <form class="px-2 mb-5 user" action="<?= base_url(); ?>/admin/comment/save" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="name" class="form-label mt-4">Masukkan email baru </label>
                                <input type="text" class="form-control form-control-user <?= ($validation->hasError('email')) ? 'is-invalid' : ''; ?>" name="email" id="name" placeholder="masukkan email disini..." value="<?= old('email'); ?>" />
                                <div class="invalid-feedback"><?= $validation->getError('email'); ?></div>
                            </div>

                            <div class="form-group">
                                <label for="name" class="form-label mt-4">Masukkan message baru </label>
                                <input type="text" class="form-control form-control-user <?= ($validation->hasError('message')) ? 'is-invalid' : ''; ?>" name="message" id="name" placeholder="masukkan message disini..." value="<?= old('message'); ?>" />
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-user <?= ($validation->hasError('id_post')) ? 'is-invalid' : ''; ?>" name="id_post" id="name" placeholder="masukkan id_post disini..." value="<?= old('id_post'); ?>" />

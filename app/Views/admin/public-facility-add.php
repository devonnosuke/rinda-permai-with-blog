            ...
            <div class="container mt-5 form">
                <div class="row">
                    ...
                    <div class="col-md-6 text-right">
                        <a href="<?= base_url(); ?>/admin/public-facility" class="btn btn-primary mb-2 ms-3">
                    ...
                    <div class="card-body">
                        <form class="px-2 mb-5 user" action="<?= base_url(); ?>/admin/public-facility/save" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-user <?= ($validation->hasError('description')) ? 'is-invalid' : ''; ?>" name="description" id="name" placeholder="masukkan Deskripsi disini..." value="<?= old('description'); ?>" />
